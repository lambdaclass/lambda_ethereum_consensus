...
sepolia: compile-all
	iex -S mix run -- --checkpoint-sync-url https://sepolia.beaconstate.info --network sepolia --metrics --keystore-dir keystore_dir --keystore-pass-dir keystore_pass_dir

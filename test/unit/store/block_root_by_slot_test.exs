defmodule Unit.Store.BlockRootBySlotTest do
  ...
  @tag :tmp_dir
  test "Basic block root saving" do
    root = Random.root()
    slot = Random.slot()
  ...
  @tag :tmp_dir
  test "Basic saving of two block roots" do
    root1 = Random.root()
    slot1 = Random.slot()
    root2 = Random.root()
    slot2 = Random.slot()
  ...
  @tag :tmp_dir
  test "Get last block root when empty" do
    assert :not_found == BlockRootBySlot.get_last_slot_block_root()
  end

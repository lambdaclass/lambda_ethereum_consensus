...
#[derive(Encode, Decode)]
pub(crate) struct BeaconBlockBodyBase<C: Config> {
    ...
    pub(crate) attester_slashings: VariableList<AttesterSlashing, C::MaxAttesterSlashings>,
    pub(crate) attestations: VariableList<Attestation, C::MaxAttestations>,
...
pub(crate) type BeaconBlockBody = BeaconBlockBodyBase<Mainnet>;
pub(crate) type BeaconBlockBodyMinimal = BeaconBlockBodyBase<Minimal>;

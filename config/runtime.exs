...
switches = [
  ...
  keystore_api: :boolean,
  keystore_api_port: :integer,
...
keystore_api_port = Keyword.get(args, :keystore_api_port, nil)
enable_keystore_api = Keyword.get(args, :keystore_api, not is_nil(keystore_api_port))
...
config :lambda_ethereum_consensus, KeyStoreApi.Endpoint,
  server: enable_keystore_api,
  http: [port: keystore_api_port || 5000],
  url: [host: "localhost"],
  render_errors: [

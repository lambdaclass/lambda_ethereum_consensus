defmodule SszGenericTestRunner do
  ...
  defp assert_ssz("valid", schema, real_serialized, real_deserialized, expected_hash_tree_root) do
    ...
    list = [{1, 8}, {2, 8}, {3, 8}, {3, 8}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}, {18446744073709551615, 64}]

    SszEx.pack(list) |> IO.inspect(limit: :infinity)
  end

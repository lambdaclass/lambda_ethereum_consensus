defmodule Types.BeaconStateDeneb do
  ...
  @type t :: %__MODULE__{
          ...
          # Execution
          # [Modified in Capella]
          latest_execution_payload_header: Types.ExecutionPayloadHeaderDeneb.t(),
          # Withdrawals
          # [New in Capella]
  ...
  def encode(%__MODULE__{} = map) do
    ...
    |> Map.update!(:latest_execution_payload_header, &Types.ExecutionPayloadHeaderDeneb.encode/1)
  end
  ...
  def decode(%__MODULE__{} = map) do
    ...
    |> Map.update!(:latest_execution_payload_header, &Types.ExecutionPayloadHeaderDeneb.decode/1)
  end
  ...
  def merge_transition_complete?(state) do
    state.latest_execution_payload_header !=
      struct(Types.ExecutionPayload, Types.ExecutionPayloadHeaderDeneb.default())
  end
  ...
  def schema do
    [
      ...
      {:latest_execution_payload_header, Types.ExecutionPayloadHeaderDeneb},
